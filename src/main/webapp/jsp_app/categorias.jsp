<%-- 
    Document   : index
    Created on : 2/04/2020, 9:01:02 p. m.
    Author     : Adminfedco
--%>
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    ...
                    <br>
                    <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>Ycalle</strong></h6>
                </div>
                <div class="main-menu">
            ...
            <div class="main-content">
                ...
                <!-- header area end cuerpo de la pantalla-->
                                    ...
                                    <form id="FrmCategorias">
                                        <div class="row mt-1"> 
                                            <div class="form-group col-sm-9 col-12" >
                                                <input type="text" id="TxtNomCategoria" name="TxtNomCategoria" class="form-control form-control-sm" placeholder="Nombre de la Categoria a buscar">
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="BtnBuscarCategoria" class="btn btn-primary btn-xs mr-1"><i class="fa fa-search" aria-hidden="true"></i> BUSCAR</button>
                                                <button type="button" id="BtnAbrirCategoria" class="btn btn-primary btn-xs"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class ="row">
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2018 <a href="https://colorlib.com/wp/">Ycalle</a>.</p>
                </div>
            </footer>
            <!-- footer area end-->
        </div>
